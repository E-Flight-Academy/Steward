    ...
    <div className="w-full max-w-2xl px-1 sm:px-4 space-y-3 sm:space-y-6">
      ...
      {flowPhase === "loading" && (
        <div aria-busy="true" className="flex justify-start items-start gap-3 animate-pulse">
          ...
          <div className="max-w-[85%] bg-white dark:bg-gray-900 px-4 py-3 rounded-2xl rounded-tl-sm shadow-[0_2px_8px_-2px_rgba(0,0,0,0.08)]">
      ...
      {flowPhase !== "loading" && messages.map((message, index) => (
        ...
        >
          ...
          <div className="max-w-[85%] bg-white dark:bg-gray-900 px-4 py-3 rounded-2xl rounded-tl-sm shadow-[0_2px_8px_-2px_rgba(0,0,0,0.08)] text-foreground">
