...
export default function MessageBubble({ message, index, onRate, onFaqClick, onAvatarClick, t, kiosk }: MessageBubbleProps) {
  return (
    ...
    >
      ...
      {message.role === "user" ? (
        <div className={`max-w-[70%] bg-[#1515F5] text-white px-4 py-3 rounded-2xl rounded-tr-sm shadow-sm ${kiosk ? "text-xl" : ""}`}>
        ...
        return (
          ...
          <div className="bg-white dark:bg-gray-900 px-4 py-3 rounded-2xl rounded-tl-sm shadow-sm text-foreground">
