  ...
  return (
    <div className="animate-fade-in-up">
      ...
      <div className="flex items-center gap-3 mb-6">
        <button
          onClick={onBack}
          className="text-e-grey hover:text-e-indigo transition-colors p-1 cursor-pointer"
          aria-label="Terug"
        >
        ...
        <div className="flex-1 min-w-0">
          ...
          {total > 0 && (
            <p className="text-sm text-e-grey">{completed}/{total} klaar</p>
          )}
        </div>
        <button
          onClick={() => {
          ...
          className="text-e-grey hover:text-red-500 transition-colors text-sm px-3 py-1.5 rounded-lg border border-e-grey-light hover:border-red-300 cursor-pointer"
        >
          Verwijder
        </button>
      </div>
      ...
      {/* Progress */}
      {total > 0 && (
        <div className="w-full bg-e-pale rounded-full h-1.5 mb-6 overflow-hidden">
          <div
      ...
      {/* Tasks */}
      {list.tasks.length === 0 ? (
        <p className="text-center text-e-grey py-12">
